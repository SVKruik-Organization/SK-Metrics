<template>
    <section class="content-wrapper">
        <article class="flex-col">
            ...
            <p>
                <strong>Belangrijk!</strong> Dit project geldt niet voor alle leerdoelen die in mijn Portfolio en SOP
                staan. Sommige leerdoelen verwerk en bewijs ik op een andere manier, en zijn daarom niet opgenomen in
                dit project. Ik houd de Portfolio nummering wel aan, dus daarom begin ik bij leerdoel 2. In het
            ...
            <p>
                ...
                ondersteuning van bewijsvoering.
            </p>
        </article>
    </section>
</template>
